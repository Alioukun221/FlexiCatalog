...
urlpatterns = [
    ...
    path('modifier-produit/<str:slug>/', views.modifier_produit, name='modifier_produit'),
    path('supprimer-produit/<str:slug>/', views.supprimer_produit, name='supprimer_produit'),
